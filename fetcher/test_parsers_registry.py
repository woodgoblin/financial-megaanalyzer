...
class TestParseStatementAutoDetection:
    ...
    def test_debit_parser_selected_for_debit_statement(self, mock_registry_reader, mock_debit_reader):
    ...
    @patch('parsers.registry.PdfReader')
    def test_credit_parser_selected_for_credit_statement(self, mock_registry_reader, mock_credit_reader):
    ...
    def test_returns_none_when_no_parser_matches(self, mock_reader_class):
        ...
        mock_page = Mock()
        mock_page.extract_text.return_value = "Random PDF content that matches no parser"
        mock_reader.pages = [mock_page]
    ...
    @patch('parsers.aib_debit.PdfReader')
    @patch('parsers.registry.PdfReader')
    def test_tries_parsers_in_registration_order(self, mock_registry_reader, mock_debit_reader):
    ...
    @patch('parsers.registry.PdfReader')
    def test_returns_none_when_parser_extract_dates_returns_none(self, mock_reader_class):
